...
elseif nargin == 3
    ...
    for i = 1:size(fieldnames(reperes),1)
        plot3(tmp{i}(1,4) , tmp{i}(2,4) , tmp{i}(3,4) , 'ko','LineWidth',2);
...
if size(fieldnames(markers),1)==12
    ...
    plot3(markers.RFWT(1), markers.RFWT(2), markers.RFWT(3),'k+','LineWidth',2);
    plot3(markers.LFWT(1), markers.LFWT(2), markers.LFWT(3),'k+','LineWidth',2);
    plot3(markers.RBWT(1), markers.RBWT(2), markers.RBWT(3),'k+','LineWidth',2);
    plot3(markers.LBWT(1), markers.LBWT(2), markers.LBWT(3),'k+','LineWidth',2);
    plot3(markers.LKNE(1), markers.LKNE(2), markers.LKNE(3),'Color','[1,0.6471,0]','Marker','+','LineWidth',2);
    plot3(markers.RKNE(1), markers.RKNE(2), markers.RKNE(3),'m+','LineWidth',2);
    plot3(markers.LKNI(1), markers.LKNI(2), markers.LKNI(3),'Color','[1,0.6471,0]','Marker','+','LineWidth',2);
    plot3(markers.RKNI(1), markers.RKNI(2), markers.RKNI(3),'m+','LineWidth',2);
    plot3(markers.LANE(1), markers.LANE(2), markers.LANE(3),'Color','[1,0.6471,0]','Marker','+','LineWidth',2);
    plot3(markers.RANE(1), markers.RANE(2), markers.RANE(3),'m+','LineWidth',2);
    plot3(markers.LANI(1), markers.LANI(2), markers.LANI(3),'Color','[1,0.6471,0]','Marker','+','LineWidth',2);
    plot3(markers.RANI(1), markers.RANI(2), markers.RANI(3),'m+','LineWidth',2);
    plot3(markers.RFem9(1),markers.RFem9(2),markers.RFem9(3),'m+','LineWidth',2);
    plot3(markers.LFem9(1),markers.LFem9(2),markers.LFem9(3),'Color','[1,0.6471,0]','Marker','+','LineWidth',2);
    plot3(markers.RFem6(1),markers.RFem6(2),markers.RFem6(3),'m+','LineWidth',2);
    plot3(markers.LFem6(1),markers.LFem6(2),markers.LFem6(3),'Color','[1,0.6471,0]','Marker','+','LineWidth',2);
    plot3(markers.RTib6(1),markers.RTib6(2),markers.RTib6(3),'m+','LineWidth',2);
    plot3(markers.LTib6(1),markers.LTib6(2),markers.LTib6(3),'Color','[1,0.6471,0]','Marker','+','LineWidth',2);
    plot3(markers.RTib1(1),markers.RTib1(2),markers.RTib1(3),'m+','LineWidth',2);
    plot3(markers.LTib1(1),markers.LTib1(2),markers.LTib1(3),'Color','[1,0.6471,0]','Marker','+','LineWidth',2);
    plot3(markers.RTal1(1),markers.RTal1(2),markers.RTal1(3),'m+','LineWidth',2);
    plot3(markers.LTal1(1),markers.LTal1(2),markers.LTal1(3),'Color','[1,0.6471,0]','Marker','+','LineWidth',2);
    plot3(markers.RHRC(1),markers.RHRC(2),markers.RHRC(3),'Color','k','Marker','o','LineWidth',2);
    plot3(markers.LHRC(1),markers.LHRC(2),markers.LHRC(3),'Color','k','Marker','o','LineWidth',2);
...
title('Markers et Reperes du Modèle')
legend(fieldnames(markers))
