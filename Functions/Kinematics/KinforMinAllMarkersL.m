function [cost] = KinforMinAllMarkersL(Angles,Sequence,Markers,Reperes,TargetMarkers,TargetPos)% [cost, Cdists, Sdists] = KinforMinAllMarkers(Angles,Sequence,Markers,Reperes,TargetMarkers,TargetPos)
